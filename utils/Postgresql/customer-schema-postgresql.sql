CREATE ROLE dashboard LOGIN ENCRYPTED PASSWORD 'md51c7f7ab511f70c343b91edc6632d858b'
...
(
   ...
   CONSTRAINT HOLDINGS_PK PRIMARY KEY (Account_id,product_id,purchase_date)
);
